...
const faqs = [
  {
    question: 'What is included in a seasonal refresh package?',
    answer: 'Our seasonal refresh package includes seasonal campaign hero imagery (5+ variations), updated lifestyle photography, social content calendar assets (15+ posts), seasonal ad creative variations (10+ sizes), and email template designs (2 templates).',
  },
  {
    question: 'How far in advance should we plan seasonal campaigns?',
    answer: 'We recommend starting seasonal campaign planning 4-6 weeks before launch. Our typical turnaround for seasonal refresh packages is 3-5 business days once we begin production.',
  },
  {
    question: 'Do you work on holiday-specific campaigns?',
    answer: 'Yes, we produce creative for all major holidays and seasonal moments—from Black Friday and holiday gifting to summer campaigns and back-to-school. Each package is customized to your seasonal goals.',
  },
]

export default function SeasonalCampaignsPageClient() {
    ...
    <>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-8">
          <motion.nav initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="mb-8">
            <ol className="flex items-center gap-2 text-sm text-stone-500">
              ...
              <li>/</li>
              <li className="text-stone-900">Seasonal Campaigns</li>
            </ol>
          </motion.nav>
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-medium text-stone-900 mb-6">
              Seasonal <span className="text-red-500">Campaign</span> Creative
            </h1>
            <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, duration: 0.6 }} className="text-lg md:text-xl text-stone-600 max-w-3xl mb-8">
              Keep your brand fresh and relevant with seasonally-appropriate creative that maintains brand consistency while capturing the moment.
            </motion.p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <FadeInSection>
              ...
              <h2 className="text-3xl md:text-4xl font-medium text-stone-900 mb-6">
                Fresh creative for every season
              </h2>
              <p className="text-stone-600 text-lg mb-8">
                From holiday campaigns to quarterly refreshes, we keep your brand feeling current without losing what makes it distinctive.
              </p>
              ...
              <div className="bg-white rounded-2xl p-8 border border-stone-200">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-3 border-b border-stone-100">
                    ...
                    <span className="font-medium text-stone-900">3-5 business days</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-stone-100">
                    <span className="text-stone-500">Ideal For</span>
                    <span className="font-medium text-stone-900">Holiday campaigns, quarterly refreshes</span>
                  </div>
      ...
      <section className="py-20 md:py-28 bg-warm-accent">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <FadeInSection>
            <h2 className="text-3xl md:text-4xl font-medium text-stone-900 mb-4">Ready to refresh?</h2>
            <p className="text-stone-600 text-lg mb-8 max-w-2xl mx-auto">
              Let&apos;s discuss your seasonal calendar and create a custom package that keeps your brand fresh all year.
            </p>
